    ...
    public class CommentMapper
    {
        ...
        public CommentModel MapCommentModel(Comment comment, IDateTimeProviderHelper dateTimeProviderHelper, List<CommentModel> replies, int totalReplies)
        {
            return new CommentModel()
            {
                ...
                CommentedAt = (comment.IsDeleted || comment.Reports.Count >= 5) ? null : dateTimeProviderHelper.GetLocalDateTime(comment.CommentedAt, comment.Commenter.Preference.Timezone),
